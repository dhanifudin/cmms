<template>
  <form @submit.prevent="handleSubmit" class="space-y-6">
    ...
    <!-- Security Options -->
    <div class="space-y-4">
      <h3 class="text-lg font-medium">Security Options</h3>
      ...
      <div class="flex items-center space-x-2">
        ...
        />
        <Label for="sendWelcomeEmail" class="text-sm font-medium leading-none peer-disabled:cursor-not-allowed peer-disabled:opacity-70">
...
// Props and Emits
interface Props {
  initialData?: Partial<CreateUserForm>;
}
